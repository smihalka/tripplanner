...
var Place = db.Place; //require('./models/place');
var Hotel = db.Hotel; //require('./models/hotel');
var Restaurant = db.Restaurant;// require('./models/restaurant');
var Activity = db.Activity;//require('./models/activity');
